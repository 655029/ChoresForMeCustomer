...
//                            verificationTextField.text = getOtp
    ...
    func callingSocailSignUpAPI() {
        self.showActivity()
        let url = URL(string: "http://3.18.59.239:3000/api/v1/social-signUp")
        let parameterDictionary = ["name": userName ?? "","email": gmailName ?? "","image":"","socialKey": RegisterViewController.socailKey ?? "","signupType":"0"] as [String: Any]
