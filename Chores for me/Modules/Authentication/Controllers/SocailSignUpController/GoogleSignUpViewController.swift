...
class GoogleSignUpViewController: BaseViewController, ADCountryPickerDelegate {
    ...
    private func callingSignUpAPI() {
        ...
        let parameterDictionary = ["name": gmailUserName.text ?? "","email": RegisterViewController.gmailName ?? "","image":"","socialKey": RegisterViewController.socailKey ?? "","signupType":"0"] as [String: Any]
